 ...
 * @author bilal
 */
@WebServlet(urlPatterns = {"/InsertTripToDB"})
public class InsertTripToDB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertTripToDB</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertTripToDB at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeUpdate("INSERT INTO trip(sourceID, destinationID, trainID, pricePerPerson, date, departureTime, arrivalTime)"
                            + "VALUES (" + source  + "," + destination + "," + trainID + "," + pricePerPerson + "," + "'" + departDate + "'" + "," + "'" + departTime + "'" + "," + "'" + arrivalTime + "'" + ")"); 
            out.println("<script type=\"text/javascript\">");
            out.println("alert('A Trip reacord has been successfuly inserted into the database');");
            out.println("location='adminAddTrip';");
            out.println("</script>");
