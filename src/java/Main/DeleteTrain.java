...
public class DeleteTrain extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteTrain</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteTrain at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String updateTableSQL = "DELETE FROM train"
				+ " WHERE id="+trainID+"";
            
            st.executeUpdate(updateTableSQL);
            out.println("<script type=\"text/javascript\">");
            out.println("alert('A train recod has been successfuly DELETED');");
            out.println("location='adminDeleteTrain.jsp';");
            out.println("</script>");
